...
elems.forEach(function (elems) {
    ...
    let index = 0;
    // declaring the animation variable to animate one items in each cycles so the whole animaiton does'nt repeat itself.
    let animation = false
